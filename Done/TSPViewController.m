...
- (void)viewDidLoad {
    ...
    [fetchRequest setSortDescriptors:@[[NSSortDescriptor sortDescriptorWithKey:@"idCoreData" ascending:YES]]];
...
- (void)configureCell:(TSPToDoCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    // Update Cell
    [cell.nameLabel setText:[record valueForKey:@"autorCoreData"]];
    [cell.songLabel setText:[record valueForKey:@"songCoreData"]];
    [cell.idLabel setText:[record valueForKey:@"idCoreData"]];
